...
const MODAL_CONTENTS = {
  ...
  help: {
    ...
    message: '🏠 HOME\n• Visualizza tutte le camere salvate\n• Statistiche: camere totali e alberghi\n• Modifica camere con l\'icona matita\n• Valutazioni per soggiorni passati\n• Icona campana per centro notifiche\n\n🔍 CERCA\n• Ricerca per nome, numero, albergo\n• Filtra per tipologia camera\n• Risultati in tempo reale\n\n➕ AGGIUNGI\n• Crea nuove camere facilmente\n• Campi obbligatori: numero, piano, albergo\n• Date soggiorno opzionali\n• Prezzo per notte con valute multiple\n• 4 tipologie: Singola, Doppia, Tripla, Suite\n\n⚙️ IMPOSTAZIONI\n• Esporta dati in formato JSON\n• Importa dati da file JSON di backup\n• Svuota cache per eliminare tutto\n• Privacy: dati salvati solo localmente\n• Gestione notifiche e promemoria\n\n📥 IMPORTA DATI\n• Disponibile solo su versione web\n• Carica file JSON esportati dall\'app\n• Rileva automaticamente duplicati\n• Aggiunge solo camere nuove\n• Mantiene dati esistenti al sicuro\n\n🔔 NOTIFICHE\n• Promemoria automatici per i tuoi soggiorni\n• Check-in: avviso 24h prima dell\'arrivo\n• Check-out: avviso 24h prima della partenza\n• Valutazione: richiesta 48h dopo il checkout\n• Personalizza orari preferiti (mattina, pomeriggio, sera)\n• Ore silenziose per non disturbare\n• Notifiche browser: autorizza per ricevere popup\n• Centro notifiche: visualizza cronologia e gestisci\n• Statistiche: notifiche non lette e programmate\n\n⚙️ IMPOSTAZIONI NOTIFICHE\n• Abilita/disabilita sistema notifiche\n• Attiva notifiche browser (richiede autorizzazione)\n• Scegli tipi promemoria (check-in, check-out, valutazione)\n• Orario preferito: mattina (8-12), pomeriggio (12-18), sera (18-23)\n• Qualsiasi orario: disabilita automaticamente ore silenziose\n• Ore silenziose: evita notifiche in fasce specifiche\n• Non puoi impostare stesso orario per preferito e silenzioso\n\n💡 SUGGERIMENTI\n• Usa il calendario per date precise\n• Aggiungi note per dettagli importanti\n• Le valutazioni appaiono dopo il checkout\n• Esporta regolarmente per backup sicuri\n• Autorizza notifiche browser per promemoria automatici\n• Controlla il centro notifiche per aggiornamenti\n• Personalizza orari per ricevere notifiche quando preferisci',
